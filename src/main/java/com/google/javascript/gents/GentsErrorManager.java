...
final class GentsErrorManager extends PrintStreamErrorManager {
    ...
    static final DiagnosticType GENTS_MODULE_PASS_ERROR = DiagnosticType.error("GENTS_MODULE_PASS_ERROR", "{0}");
    static final DiagnosticType GENTS_CLASS_PASS_ERROR = DiagnosticType.error("GENTS_CLASS_PASS_ERROR", "{0}");
    ...
    public void report(CheckLevel level, JSError error) {
        ...
        if (!this.debug && level == CheckLevel.WARNING) {
            return;
        }
