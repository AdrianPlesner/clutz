...
public abstract class ImportBasedMapBuilder {
    protected abstract Map<String, String> build(String localModuleId, Node moduleBody, Set<String> googProvides);
    ...
    protected static boolean isImportAssignment(Node statement) {
        ...
        return rightHandSide != null && rightHandSide.isCall() && (rightHandSide.getFirstChild().matchesQualifiedName("goog.require")
                        || rightHandSide.getFirstChild().matchesQualifiedName("goog.module.get") || rightHandSide.getFirstChild()
    ...
    protected static boolean isImportDestructuringAssignment(Node statement) {
        ...
        return rightHandSide.isCall() && (rightHandSide.getFirstChild().matchesQualifiedName("goog.require") || rightHandSide.getFirstChild()
