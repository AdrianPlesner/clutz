    ...
    protected Map<String, String> build(String localModuleId, Node moduleBody, Set<String> googProvides) {
        ...
        for (Node statement : moduleBody.children()) {
            ...
            if (isImportAssignment(statement)) {
                ...
                for (Entry<String, String> e : objectLiteralASTToStringMap(statement.getFirstFirstChild()).entrySet()) {
                ...
                for (Entry<String, String> e : objectLiteralASTToStringMap(statement.getFirstFirstChild()).entrySet()) {
                    ...
                    String exportedSymbolName = importRenameMap.get(destructuredVariable) + "." + originalName;
