...
public class ClutzErrorManagerTest {
    ...
    public void testMissingSymbolOrExtern() {
        assertThatProgram("goog.provide('foo.x');", "/** @param {some.Unknown} y */", "foo.x = function(y) {};").diagnosticStream()
    ...
    public void testDuplicateSymbol() {
        // Useful
        assertThatProgram("/** @type {number} */ var x = 1;", "/** @type {number} */ var x = 2;").diagnosticStream()
    ...
    public void testReportsWarningsInTests() {
        assertThatProgram("/** @see */", "var noSee;").diagnosticStream().containsMatch("WARNING.*@see tag missing description");
    }
}
