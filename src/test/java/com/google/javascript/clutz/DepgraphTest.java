...
public class DepgraphTest {
    ...
    static Depgraph parseFile(String filename) {
        return Depgraph.parseFrom(Collections.singletonList(DeclarationGeneratorTest.getTestInputFile(filename).toFile().toString()));
    }

    @Test
    public void testParseFile() throws Exception {
        Depgraph depgraph = parseFile("closure.depgraph");
        assertThat(depgraph.getRoots()).containsExactly("my/thing/static/js/annotations/annotations-canvas-controller.js",
                                                        "blaze-out/blah/my/blaze-out-file.js").inOrder();
        assertThat(depgraph.getNonroots()).containsExactly("javascript/closure/base.js", "javascript/closure/string/string.js").inOrder();
