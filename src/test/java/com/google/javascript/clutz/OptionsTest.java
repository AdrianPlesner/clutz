...
public class OptionsTest {
    ...
    public void testFullUsage() throws Exception {
        Options opts = new Options(new String[] { "foo.js", "--externs", "extern1.js", "extern2.js", "-o", "output.d.ts" });
    ...
    public void testFilterSourcesDepgraphs() throws Exception {
        Options opts = new Options(new String[] { "javascript/closure/other_file_not_in_depgraph.js", "javascript/closure/string/string.js",
                        "blaze-out/blah/my/blaze-out-file.js", "--depgraphs", DepgraphTest.DEPGRAPH_PATH.toFile().toString(), "--depgraphs_filter_sources", });
        // Arguments are filtered by what appears in the depgraph.
        assertThat(opts.arguments).containsExactly("javascript/closure/string/string.js", // kept as a root in depgraph
    ...
    public void testFilterSourcesWithExternsInDepgraphs() throws Exception {
        Options opts = new Options(new String[] { "javascript/closure/string/string.js", "--externs", "extern1.js", "extern2.js", "--depgraphs",
                        DepgraphTest.DEPGRAPH_PATH.toFile().toString(), "--depgraphs_filter_sources", });
        // All depgraph externs are added to the externs list.
        assertThat(opts.externs).containsExactly("my/root/extern.js", "my/nonroot/extern.js", "extern1.js", "extern2.js").inOrder();
    }

    @Test
    public void testClosureEntryPoint() throws Exception {
        Options opts = new Options(
                        new String[] { "foo.js", "--closure_entry_points", "ns.entryPoint1", "ns.entryPoint2", "--externs", "extern1.js", "extern2.js", "-o",
                                        "output.d.ts" });
        assertThat(opts.arguments).containsExactly("foo.js");
    ...
    public void testExternsShouldBeUnique() throws Exception {
        Options opts = new Options(new String[] { "--externs", "my/root/extern.js", "--depgraphs",
    ...
    public void testShouldSupportFilePathsWithSpaces() throws Exception {
        Options opts = new Options(new String[] { "--externs", "dir with spaces/common/dom.js", "--externs", "common/browser api.js", });
        assertThat(opts.externs).containsExactly("dir with spaces/common/dom.js", "common/browser api.js");
    }

    @Test
    public void testPartialInputIgnoresDepgraphNonRootExterns() throws Exception {
        Options opts = new Options(new String[] { "--partialInput",
                        // a random file from the depgraph. Not relevant to the test, but we need at least
                        // one input.
                        "my/thing/static/js/0-bootstrap.js", "--depgraphs", DepgraphTest.DEPGRAPH_PATH.toFile().toString(), });
        assertThat(opts.externs).isEmpty();
    }

    @Test
    public void testClosureEnvCustom() throws Exception {
        Options opts = new Options(new String[] { "my/thing/static/js/0-bootstrap.js", "--closure_env", "CUSTOM", });
        assertThat(opts.closureEnv).isEqualTo(CompilerOptions.Environment.CUSTOM);
        assertThat(opts.getCompilerOptions().getEnvironment()).isEqualTo(CompilerOptions.Environment.CUSTOM);
    }
    ...
    public void testStopOption() throws Exception {
        Options opts = new Options(new String[] { "--externs", "extern1.js", "extern2.js", "--", "foo.js", "bar.js" });
